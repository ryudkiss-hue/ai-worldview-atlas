  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-center">
      ...
      <p className="text-gray-700 mb-4">
        This is a 124-question survey about how you think AI development should go, both in the
      ...
      <p className="text-sm text-gray-500 mb-2">
        About 17-22 minutes, 124 questions. Your answers aren't saved if you refresh mid-quiz —
