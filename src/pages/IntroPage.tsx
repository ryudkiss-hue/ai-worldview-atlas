  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-center">
      ...
      <p className="text-gray-700 mb-4">
        ...
        different dimensions, and matches you to the closest of 50 named viewpoints.
      </p>
      <p className="text-sm text-gray-500 mb-2">
        About 19-25 minutes, 145 questions. Your answers aren't saved if you refresh mid-quiz —
